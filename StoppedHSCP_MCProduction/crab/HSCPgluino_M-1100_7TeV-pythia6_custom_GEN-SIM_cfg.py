...
# with the Pythia6GeneratorFilter module modified for M = 1100GeV.
#
...
process.g4SimHits = cms.EDProducer("OscarProducer",
    ...
    Physics = cms.PSet(
        ...
        particlesDef = cms.FileInPath('Configuration/Generator/data/particles_gluino_1100_GeV.txt'),
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    processParameters = cms.vstring('MSEL=0          ! User defined processes',
                                    ...
                                    'IMSS(3)=1',
                                    'RMSS(1)=550.000000 !should be gluino mass/2',
                                    'RMSS(2)=550.000000 !should be gluino mass/2',
                                    'RMSS(3)=1100.000000 !should be gluino mass',
                                    'RMSS(10)=2420.000000 !RMSS(10)=2.2*mass gluino',
                                    'RMSS(11)=2310.000000 !RMSS(10)=2.1*mass gluino',
                                    'RMSS(12)=2200.000000 !should be gluino mass X2',
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('hscpGluino_M1100_7TeV-pythia6_Summer11-START311_V2-v1_GEN-SIM_stage1.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/HSCPgluino_M_1100_7TeV_pythia6_cff.py nevts:1')
)
