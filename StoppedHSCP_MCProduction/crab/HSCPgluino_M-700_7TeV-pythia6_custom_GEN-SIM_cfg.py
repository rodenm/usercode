# September 26, 2011 - Marissa Rodenburg
#
# Copied from HSCPgluino_M-300_7TeV-pythia6_Summer11-START311_V2-v1_GEN-SIM_cfg.py
# with the Pythia6GeneratorFilter module modified for M = 700GeV.
#
# I've also changed line 239 of GeneratorInterface/Pythia6Interface/plugins/pythia_gluinohadron.f
# to create a different fragmentation function based on Chris's intuition.
...
process.g4SimHits = cms.EDProducer("OscarProducer",
    ...
    Physics = cms.PSet(
        ...
        particlesDef = cms.FileInPath('Configuration/Generator/data/particles_gluino_700_GeV.txt'),
    ...
    G4Commands = cms.vstring('/tracking/verbose 1'),
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
                                 ...
                                 particleFile = cms.untracked.string('Configuration/Generator/data/particles_gluino_700_GeV.txt'),
                                 filterEfficiency = cms.untracked.double(1.0),
                                 pdtFile = cms.FileInPath('Configuration/Generator/data/hscppythiapdtgluino700.tbl'),
    ...
    processParameters = cms.vstring('MSEL=0          ! User defined processes',
                                    ...
                                    'IMSS(3)=1',
                                    'RMSS(1)=350.000000 !should be gluino mass/2',
                                    'RMSS(2)=350.000000 !should be gluino mass/2',
                                    'RMSS(3)=700.000000 !should be gluino mass',
                                    'RMSS(10)=1540.000000 !RMSS(10)=2.2*mass gluino',
                                    'RMSS(11)=1470.000000 !RMSS(10)=2.1*mass gluino',
                                    'RMSS(12)=1400.000000 !should be gluino mass X2',
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('hscpGluino_M700_7TeV-pythia6_Summer11-START311_V2-v1_GEN-SIM_stage1.root'),
...
# I don't want the original super-complicated messageLogger module. Get it off DBS again if you do.
#process.MessageLogger = cms.Service(
#    "MessageLogger",
    #debugModules = cms.untracked.vstring('siStripThresholdDummyDBWriter'),
#    threshold = cms.untracked.string('DEBUG'),
#    destinations = cms.untracked.vstring('log_HSCPgluino_M-300.log')
#)
...
process.MessageLogger = cms.Service(
    ...
    cerr_stats = cms.untracked.PSet(threshold = cms.untracked.string('DEBUG'), # Was WARNING
    ...
    cerr = cms.untracked.PSet(INFO = cms.untracked.PSet(limit = cms.untracked.int32(0)),
                              noTimeStamps = cms.untracked.bool(False),
                              FwkReport = cms.untracked.PSet(reportEvery = cms.untracked.int32(3),
                                                             optionalPSet = cms.untracked.bool(True),
                                                             limit = cms.untracked.int32(10000000)
                                                             ),
                              default = cms.untracked.PSet(limit = cms.untracked.int32(10000000)),
                              Root_NoDictionary = cms.untracked.PSet(optionalPSet = cms.untracked.bool(True),
                                                                     limit = cms.untracked.int32(0)
                                                                     ),
                              threshold = cms.untracked.string('INFO'),
                              FwkJob = cms.untracked.PSet(optionalPSet = cms.untracked.bool(True),
                                                          limit = cms.untracked.int32(0)
                                                          ),
                              FwkSummary = cms.untracked.PSet(reportEvery = cms.untracked.int32(1),
                                                              optionalPSet = cms.untracked.bool(True),
                                                              limit = cms.untracked.int32(10000000)
                                                              ),
                              optionalPSet = cms.untracked.bool(True)
    ...
    FrameworkJobReport = cms.untracked.PSet(default = cms.untracked.PSet(limit = cms.untracked.int32(0)),
                                            optionalPSet = cms.untracked.bool(True),
                                            FwkJob = cms.untracked.PSet(optionalPSet = cms.untracked.bool(True),
                                                                        limit = cms.untracked.int32(10000000)
                                                                        )
    ...
    infos = cms.untracked.PSet(optionalPSet = cms.untracked.bool(True),
                               Root_NoDictionary = cms.untracked.PSet(optionalPSet = cms.untracked.bool(True),
                                                                      limit = cms.untracked.int32(0)
                                                                      ),
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/HSCPgluino_M_700_7TeV_pythia6_cff.py nevts:1')
)
...
# Set the max number of events to produce
