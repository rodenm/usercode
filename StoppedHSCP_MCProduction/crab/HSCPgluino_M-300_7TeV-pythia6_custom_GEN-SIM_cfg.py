...
# with the Pythia6GeneratorFilter module modified for M = 300GeV.
#
...
process.g4SimHits = cms.EDProducer("OscarProducer",
    ...
    Physics = cms.PSet(
        ...
        particlesDef = cms.FileInPath('Configuration/Generator/data/particles_gluino_300_GeV.txt'),
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
                                 ...
                                 particleFile = cms.untracked.string('Configuration/Generator/data/particles_gluino_300_GeV.txt'),
                                 filterEfficiency = cms.untracked.double(1.0),
                                 pdtFile = cms.FileInPath('Configuration/Generator/data/hscppythiapdtgluino300.tbl'),
    ...
    processParameters = cms.vstring('MSEL=0          ! User defined processes',
                                    ...
                                    'IMSS(3)=1',
                                    'RMSS(1)=150.000000 !should be gluino mass/2',
                                    'RMSS(2)=150.000000 !should be gluino mass/2',
                                    'RMSS(3)=300.000000 !should be gluino mass',
                                    'RMSS(10)=660.000000 !RMSS(10)=2.2*mass gluino',
                                    'RMSS(11)=630.000000 !RMSS(10)=2.1*mass gluino',
                                    'RMSS(12)=600.000000 !should be gluino mass X2',
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('hscpGluino_M300_7TeV-pythia6_Summer11-START311_V2-v1_GEN-SIM_stage1.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/HSCPgluino_M_300_7TeV_pythia6_cff.py nevts:1')
)
